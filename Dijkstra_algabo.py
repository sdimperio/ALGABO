"""Implementaciòn del Algoritmo de Djikstra para encontrar el camino más corto entre ls nodos de un grafo
"""
...
class Graph:
    def __init__(self, filename):
        """Cada grafo tiene un nodo de comienzo, un nodo de fin, una distancia, delimitado.

        Hay dos propiedades que estàn siendo usadas por el algortimo
        de Dijkstra en el mètodo de camino más corto:
        self.nodes = coloca todos los nodos unicos en el grafo
        self.adjacency_list = muestra para cada nodo un conjunto desordenado de aristas, tuplas (nodo_adyacente,arista)
        """

        # graph_edges es una lista de listas que contempla
        # [from_node, to_node, distancia].
        #  
        graph_edges = []
